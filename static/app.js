    ...
    map.events.add('ready', function () {
        ...
        boundarySource.add(new atlas.data.Feature(
            new atlas.data.LineString([
                [77.665309, 12.927045], // NW (12.927045/77.665309)
                [77.672074, 12.927340], // NE (12.927340/77.672074)
                [77.671669, 12.923943], // SE (12.923943/77.671669)
                [77.665591, 12.921052], // SW (12.921052/77.665591)
                [77.665309, 12.927045]  // Close the loop
            ])
        ));
